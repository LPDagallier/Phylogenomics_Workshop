...
## Preparation
After having defined the analysis unique identifier `<analysis_ID>`, and created a subfolder in the `DATA`directory (see [here](Notes_for_advanced_wf.md) for details) we need:
