...
- [`hybpiper assemble`][1. Assembly]: for each sample, assembles the targeted loci  
- [`hybpiper extract`][2. Locus extraction]: for each locus, extract the assembled sequences for the samples  
