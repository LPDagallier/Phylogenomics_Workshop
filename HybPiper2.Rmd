...
- `hybpiper extract`: for each locus, extract the assembled sequences for the samples  
...
## 1. Assembly 
:point_right: :computer: Jump directly to the [script for local use](PHYLOGENY_RECONSTRUCTION/SCRIPTS_local/hybpiper2_assemble.sh)  
:point_right: :woman_technologist: Jump directly to the [script for cluster (SLURM) use](PHYLOGENY_RECONSTRUCTION/SCRIPTS_cluster/hybpiper2_assemble_TEMPLATE.sh). 
...
## 2. Locus extraction
:point_right: :computer: Jump directly to the [script for local use](PHYLOGENY_RECONSTRUCTION/SCRIPTS_local/hybpiper2_extract.sh)  
:point_right: :woman_technologist: Jump directly to the [script for cluster (SLURM) use](PHYLOGENY_RECONSTRUCTION/SCRIPTS_cluster/hybpiper2_extract_TEMPLATE.sh). 
