...
:point_right: :computer: See directly the [script for local use](READS CLEANING/SCRIPTS_local/Reads_cleaning.sh)  
:point_right: :woman_technologist: See directly the [script for cluster (SLURM) use](READS CLEANING/SCRIPTS_cluster/reads_cleaning_TEMPLATE.sh), or jump to [Note for cluster users][Note for cluster (SLURM) users]. 
...
Compute the statistics for every alignment file and store all these stats in a file called `mapping_statistics.csv`.
...
You can modify the [`reads_cleaning_TEMPLATE.sh`](READS CLEANING/SCRIPTS_cluster/reads_cleaning_TEMPLATE.sh) script:
