...
Similarly as above, writing manually the command for every subset can be cumbersome, so let's write it into a loop to run ASTRAL on all the files in the folder:
```{bash}
path_to_input=$path_to_jobs_out/$folder/trees/
cd $path_to_input
ls -1 *bs10.trees | \
