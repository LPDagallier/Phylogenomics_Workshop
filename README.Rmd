...
:point_right: See the [Reads Cleaning (TO DO)](reads_cleaning.md) document for a detailed explanation.
...
:point_right: **See [HybPiper2](HybPiper2.md) for advanced HybPiper workflow details**. Associated :computer: [scripts for local use](PHYLOGENY_RECONSTRUCTION/SCRIPTS_local/) and :woman_technologist: [scripts for cluster (SLURM) use](PHYLOGENY_RECONSTRUCTION/SCRIPTS_cluster/). 
